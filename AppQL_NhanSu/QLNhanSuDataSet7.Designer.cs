...
namespace AppQL_NhanSu {
    ...
    public partial class QLNhanSuDataSet7 : global::System.Data.DataSet {
        ...
        public partial class PhongBanDataTable : global::System.Data.TypedTableBase<PhongBanRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public PhongBanRow AddPhongBanRow(string MaPB, string TenPB, string SDT) {
...
namespace AppQL_NhanSu.QLNhanSuDataSet7TableAdapters {
    ...
    public partial class PhongBanTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PhongBan] WHERE (([MaPB] = @Original_MaPB) AND ([TenPB] = @Ori" +
                "ginal_TenPB) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)" +
                "))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PhongBan] SET [MaPB] = @MaPB, [TenPB] = @TenPB, [SDT] = @SDT WHERE (([MaPB] = @Original_MaPB) AND ([TenPB] = @Original_TenPB) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)));
SELECT MaPB, TenPB, SDT FROM PhongBan WHERE (MaPB = @MaPB)";
        ...
        public virtual int Fill(QLNhanSuDataSet7.PhongBanDataTable dataTable) {
        ...
        public virtual QLNhanSuDataSet7.PhongBanDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLNhanSuDataSet7.PhongBanDataTable dataTable = new QLNhanSuDataSet7.PhongBanDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLNhanSuDataSet7.PhongBanDataTable dataTable) {
        ...
        public virtual int Delete(string Original_MaPB, string Original_TenPB, string Original_SDT) {
        ...
        public virtual int Insert(string MaPB, string TenPB, string SDT) {
            if ((MaPB == null)) {
        ...
        public virtual int Update(string MaPB, string TenPB, string SDT, string Original_MaPB, string Original_TenPB, string Original_SDT) {
            if ((MaPB == null)) {
                throw new global::System.ArgumentNullException("MaPB");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenPB, string SDT, string Original_MaPB, string Original_TenPB, string Original_SDT) {
